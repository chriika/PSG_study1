...
btnMakeCol. = '#dddddd'
btnDecreaseTxt. = 'decrease other'
btnIncreaseTxt. = 'increase other'
btnMakeTxt. = 'set minimum share'
...
confirmText. = 'Confirm your minimum share or make adaptions if necessary'
